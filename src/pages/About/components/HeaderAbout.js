  ...
  return (
    <div class="px-[8vw] my-[6vw] lg:my-[6vw] w-full z-10 ">
      <div class="flex justify-between flex-wrap items-center w-full ">
        ...
        <motion.div
          class="w-full md:w-[50%] text-[#757575] text-[16px] md:text-[20px]"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <p>
            <br />
            We analyze every detail of your work needs, strive for the best way
            to solve problems with measurable analysis. creating not only
