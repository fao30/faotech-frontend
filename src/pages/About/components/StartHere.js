...
const StartHere = () => {
  return (
    <div class="w-full lg:my-64 mb-40">
      <div class="my-16 md:mx-[5rem] lg:mx-[9.5rem] mx-10 px-6 flex justify-center content-center flex-wrap items-center rounded-xl  bg-white border-2 shadow-xl ">
        <div className="mt-8 lg:mt-3 px-[2rem] md:px-2 mb-2 flex justify-center flex-col items-center">
          <h1 class="font-[700] leading-[36px] md:leading-[50px] lg:leading-[84px] text-[#1363DF] text-[28px] md:text-[44px] pb-1 sm:text-center text-left">
            Let’s create something amazing together
          </h1>
          <p class=" text-[#757575] text-[16px] md:text-[21px] font-[400] mt-1 text-left">
