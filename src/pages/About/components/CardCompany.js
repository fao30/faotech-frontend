...
const CardCompany = ({ cardDescProps, cardTitleProps }) => {
  return (
    <div className="px-4 w-[100%] md:w-[45%] h-[12rem] md:h-[16rem] lg:h-[12rem] my-6 flex flex-row space-x-4 flex-wrap justify-start items-center bg-[#FEFEFF] text-ourWork-100  shadow-xl rounded-2xl">
