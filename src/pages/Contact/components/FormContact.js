        ...
        <div className="flex flex-col flex-wrap gap-x-10 gap-y-5">
          ...
          <div className="col-start-1 col-end-3">
            <div className="flex flex-col md:gap-y-2">
              ...
              <textarea
                type="text"
                className={`h-[15rem] px-3 py-2 text-sm drop-shadow-[1px_1px_2.1px_#ababab] bg-white rounded-lg md:py-3 lg:py-3 focus:ring-0 lg:text-lg text-black outline-[#4C6BDC] `}
                name="textarea"
