...
const Index = () => {
  return (
    <div>
      {/* BACKGROUND */}
      <div class="flex absolute blur-3xl rounded-full rounded-br-2xl sm:w-[30rem] w-[10rem] h-[50rem] sm:h-[42rem] lg:w-[60rem] lg:h-[60rem] top-[32rem] lg:top-[8rem] right-0  bg-[#eaf0fa] -z-10 "></div>
