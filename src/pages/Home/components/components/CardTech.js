...
const CardTech = ({ cardIconProps, cardTitleProps }) => {
  return (
    <div className="py-1 items-center flex  bg-white text-ourWork-100  shadow-xl rounded-2xl w-[40%] md:w-[25%] lg:w-[20%] transition-all transform hover:scale-105 hover:cursor-pointer">
