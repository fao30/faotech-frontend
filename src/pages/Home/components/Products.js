...
const Products = () => {
  return (
    <div class="from-white to-blue-200 text-primary-content -mt-[5rem] grid place-items-center items-end bg-gradient-to-r pt-20">
      ...
      <div class=" flex lg:justify-around justify-left flex-wrap items-left text-right-top">
        <div class="mx-20 w-full lg:w-96">
          <h1 class="text-xl text-black text-left">
            Communication Platform for Business to Business Partners application
            with FaoTech
          </h1>
          <p class="text-sm my-6 indent-8 text-gray-500 text-left-buttom">
            B2B-ONE.COM - it is an effective platform for communication between
        ...
        <div class="flex flex-wrap justify-center">
          <img
            class="object-right-bottom h-65 w-96 max-w-l transition-shadow ease-in-out duration-300 shadow-none hover:shadow-xl"
